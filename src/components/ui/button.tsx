...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-primary focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-accent-primary text-[#08111A] shadow-glow hover:shadow-glow-lg hover:brightness-105",
        ghost: "border border-ink/10 bg-transparent text-ink hover:border-accent-primary/30 hover:bg-accent-primary/5",
