        ...
        <Reveal className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col items-center lg:items-start">
            <div className="relative mb-8">
              <div className="absolute -inset-3 rounded-full border border-accent-primary/20" aria-hidden="true" />
          ...
          <div className="rounded-2xl bg-surface p-8 shadow-card sm:p-10">
            ...
            <p className="mb-5 text-sm font-semibold text-accent-primary">Founder, Arivo</p>
            ...
            <div className="mb-6 flex flex-wrap gap-2">
              {highlights.map(({ label, icon: Icon }) => (
                <span
                  key={label}
                  className="inline-flex items-center gap-1.5 rounded-full border border-accent-primary/20 bg-accent-primary/10 px-3 py-1.5 text-[11px] font-semibold text-accent-primary"
                >
              ...
              {socialLinks.map((link) => {
                ...
                return (
                  <a
                    ...
                    className="flex h-10 w-10 items-center justify-center rounded-[10px] border border-ink/10 bg-page text-ink-muted transition-colors hover:border-accent-primary/30 hover:bg-accent-primary/10 hover:text-accent-primary"
                  >
