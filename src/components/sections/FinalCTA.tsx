...
export const FinalCTA: React.FC = () => {
  return (
    <Section variant="dark" id="cta" className="relative text-center overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-accent-primary/10 rounded-full blur-3xl -z-10" />
      <div className="absolute bottom-0 left-1/3 w-[300px] h-[300px] bg-[#14b8a6]/10 rounded-full blur-3xl -z-10" />

      <div className="max-w-3xl mx-auto py-8">
        <span className="section-label text-accent-primary font-bold uppercase tracking-[0.15em] block mb-4">
