...
const highlights = ["Decision Intelligence", "Financial Engine", PLAY_STORE_LABEL];
        ...
        <Reveal className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="flex flex-col items-center lg:items-start">
            <div className="relative mb-8">
              <div
                className="absolute -inset-3 rounded-full border border-[#22C55E]/20"
                aria-hidden="true"
              />
              <div className="relative h-56 w-56 overflow-hidden rounded-full border-4 border-black shadow-[0_16px_48px_rgba(34,197,94,0.15)] sm:h-64 sm:w-64">
                <Image
            ...
            <blockquote className="max-w-sm text-center lg:text-left">
              <p className="font-display text-lg font-bold italic leading-snug text-white">
                &ldquo;Life&apos;s biggest money decisions deserve more than guesswork.&rdquo;
              </p>
            </blockquote>
          </div>

          <div className="glass-card p-8 transition-all duration-350 hover:border-[#22C55E]/20 sm:p-10">
            <span className="section-label">Founder</span>
            <h2 id="founder-heading" className="mb-1 font-display text-3xl font-extrabold tracking-tight text-white">
              Akhilesh Goswami
            </h2>
            <p className="mb-5 text-sm font-semibold text-[#22C55E]">Founder, Arivo</p>
            ...
            <div className="mb-6 flex flex-wrap gap-2">
              {highlights.map((tag) => (
                <span
                  key={tag}
                  className="rounded-full border border-[#22C55E]/20 bg-[#22C55E]/10 px-3 py-1.5 text-[11px] font-semibold text-[#22C55E]"
                >
                  {tag}
                </span>
              ))}
            ...
            <div className="flex flex-wrap gap-2">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-[10px] border border-white/10 bg-white/5 text-arivo-muted transition-colors hover:border-[#22C55E]/30 hover:bg-[#22C55E]/10 hover:text-[#22C55E]"
                >
