...
const navItems = [
  ...
  { href: "/veris/", label: "Veris", icon: MessageSquare },
        ...
        <>
          <div className="flex h-16 items-center gap-3 border-b border-app-border px-5">
            ...
            <div>
              ...
              <span className="text-[11px] text-app-muted">Your Financial OS.</span>
            </div>
          </div>
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <Icon className={cn("h-[18px] w-[18px]", active && "text-app-accent")} aria-hidden="true" />
                  {item.label}
                  {item.label === "Veris" && (
          ...
          <div className="border-t border-app-border p-3 mt-auto">
            <button
              type="button"
              onClick={logout}
              className="flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-app-muted transition-all duration-200 hover:bg-app-danger/10 hover:text-app-danger"
            >
    ...
    <header className="sticky top-0 z-40 flex h-16 items-center justify-between border-b border-app-border bg-app-bg/80 px-4 backdrop-blur-xl sm:px-6">
      <div className="flex items-center gap-2.5">
        <button
          ...
          className="hidden lg:flex h-9 w-9 items-center justify-center rounded-xl border border-app-border bg-app-card text-app-muted hover:text-app-text transition-colors mr-2"
