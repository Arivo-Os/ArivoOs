import type { ApiGoal, DecisionHistoryRecord, JourneyTimelineEvent, OutcomeRecord } from "@/lib/api/types/api";
import { mockMilestones } from "@/lib/api/mock-data";
import { hasApiConfigured } from "@/lib/api/client";
import { outcomeStatusLabel } from "@/lib/api/outcomes.service";
